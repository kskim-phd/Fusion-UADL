...
class Logger(object):
    ...
    def __init__(self, fn, ask=True, local_rank=0):
        ...
        if self.local_rank == 0:
            # if not os.path.exists("/home/mars/workspace/ljh_workspace/Contrastive_CXR-3D/logs_new3D_test"):
            #     os.mkdir("/home/mars/workspace/ljh_workspace/Contrastive_CXR-3D/logs_new3D_test")
